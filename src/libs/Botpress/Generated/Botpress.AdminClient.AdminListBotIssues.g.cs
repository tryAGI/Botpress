...
namespace Botpress
{
    public partial class AdminClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_AdminListBotIssuesSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_AdminListBotIssuesSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_AdminListBotIssuesSecurityRequirement0,
            };
        partial void PrepareAdminListBotIssuesArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string? nextToken,
            ref string xWorkspaceId,
            ref string? xMultipleIntegrations);
        partial void PrepareAdminListBotIssuesRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AdminListBotIssuesAsync(
            string id,
            string xWorkspaceId,
        ...
        {
            await AdminListBotIssuesAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> AdminListBotIssuesAsResponseAsync(
            string id,
            string xWorkspaceId,
            string? nextToken = default,
            string? xMultipleIntegrations = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAdminListBotIssuesArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AdminListBotIssuesSecurityRequirements,
                operationName: "AdminListBotIssuesAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AdminListBotIssues",
                                methodName: "AdminListBotIssuesAsync",
                                pathTemplate: "$\"/v1/admin/bots/{id}/issues\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAdminListBotIssuesResponse(
                    httpClient: HttpClient,
