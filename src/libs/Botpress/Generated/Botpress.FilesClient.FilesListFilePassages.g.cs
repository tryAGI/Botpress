...
namespace Botpress
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_FilesListFilePassagesSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_FilesListFilePassagesSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_FilesListFilePassagesSecurityRequirement0,
            };
        partial void PrepareFilesListFilePassagesArguments(
        ...
        partial void PrepareFilesListFilePassagesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessFilesListFilePassagesResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task FilesListFilePassagesAsync(
            string id,
            string xBotId,
        ...
        {
            await FilesListFilePassagesAsResponseAsync(
                id: id,
                xBotId: xBotId,
                nextToken: nextToken,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> FilesListFilePassagesAsResponseAsync(
            string id,
            string xBotId,
            string? nextToken = default,
            double? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareFilesListFilePassagesArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FilesListFilePassagesSecurityRequirements,
                operationName: "FilesListFilePassagesAsync");
            ...
            if (xUserRole != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareFilesListFilePassagesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FilesListFilePassages",
                                methodName: "FilesListFilePassagesAsync",
                                pathTemplate: "$\"/v1/files/{id}/passages\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFilesListFilePassagesResponse(
                    httpClient: HttpClient,
