...
namespace Botpress
{
    public partial class TablesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_TablesFindTableRowsSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_TablesFindTableRowsSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_TablesFindTableRowsSecurityRequirement0,
            };
        partial void PrepareTablesFindTableRowsArguments(
        ...
        partial void PrepareTablesFindTableRowsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessTablesFindTableRowsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task TablesFindTableRowsAsync(
            string table,
            string xBotId,
        ...
        {
            await TablesFindTableRowsAsResponseAsync(
                table: table,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> TablesFindTableRowsAsResponseAsync(
            string table,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTablesFindTableRowsArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TablesFindTableRowsSecurityRequirements,
                operationName: "TablesFindTableRowsAsync");
            ...
            if (xUserRole != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTablesFindTableRowsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TablesFindTableRows",
                                methodName: "TablesFindTableRowsAsync",
                                pathTemplate: "$\"/v1/tables/{table}/rows/find\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTablesFindTableRowsResponse(
                    httpClient: HttpClient,
