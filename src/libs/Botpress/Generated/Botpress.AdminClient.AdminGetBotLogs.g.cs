...
namespace Botpress
{
    public partial class AdminClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_AdminGetBotLogsSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_AdminGetBotLogsSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_AdminGetBotLogsSecurityRequirement0,
            };
        partial void PrepareAdminGetBotLogsArguments(
        ...
        partial void PrepareAdminGetBotLogsRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessAdminGetBotLogsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AdminGetBotLogsAsync(
            string id,
            string timeStart,
            string xWorkspaceId,
        ...
        {
            await AdminGetBotLogsAsResponseAsync(
                id: id,
                timeStart: timeStart,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> AdminGetBotLogsAsResponseAsync(
            string id,
            string timeStart,
            string xWorkspaceId,
            string? timeEnd = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAdminGetBotLogsArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AdminGetBotLogsSecurityRequirements,
                operationName: "AdminGetBotLogsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AdminGetBotLogs",
                                methodName: "AdminGetBotLogsAsync",
                                pathTemplate: "$\"/v1/admin/bots/{id}/logs\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAdminGetBotLogsResponse(
                    httpClient: HttpClient,
