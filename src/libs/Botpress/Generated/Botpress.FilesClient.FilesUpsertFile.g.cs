...
namespace Botpress
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_FilesUpsertFileSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_FilesUpsertFileSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_FilesUpsertFileSecurityRequirement0,
            };
        partial void PrepareFilesUpsertFileArguments(
        ...
        partial void PrepareFilesUpsertFileRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessFilesUpsertFileResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task FilesUpsertFileAsync(
            string xBotId,
        ...
        {
            await FilesUpsertFileAsResponseAsync(
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> FilesUpsertFileAsResponseAsync(
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            string? xIntegrationName = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareFilesUpsertFileArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FilesUpsertFileSecurityRequirements,
                operationName: "FilesUpsertFileAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FilesUpsertFile",
                                methodName: "FilesUpsertFileAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFilesUpsertFileResponse(
                    httpClient: HttpClient,
