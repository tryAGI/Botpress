...
namespace Botpress
{
    public partial class RuntimeClient
    {
        ...
        partial void PrepareRuntimeGetParticipantRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RuntimeGetParticipantAsync(
            string id,
            string userId,
            string xBotId,
        ...
        {
            await RuntimeGetParticipantAsResponseAsync(
                id: id,
                userId: userId,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeGetParticipantAsResponseAsync(
            string id,
            string userId,
            string xBotId,
            string? xIntegrationId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRuntimeGetParticipantArguments(
            ...
            if (xIntegrationAlias != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRuntimeGetParticipantRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RuntimeGetParticipant",
                                methodName: "RuntimeGetParticipantAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRuntimeGetParticipantResponse(
                    httpClient: HttpClient,
