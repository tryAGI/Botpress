...
namespace Botpress
{
    public partial class RuntimeClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_RuntimeGetMessageSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_RuntimeGetMessageSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_RuntimeGetMessageSecurityRequirement0,
            };
        partial void PrepareRuntimeGetMessageArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string xBotId,
            ref string? xIntegrationId,
            ref string? xIntegrationAlias);
        partial void PrepareRuntimeGetMessageRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessRuntimeGetMessageResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RuntimeGetMessageAsync(
            string id,
            string xBotId,
        ...
        {
            await RuntimeGetMessageAsResponseAsync(
                id: id,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeGetMessageAsResponseAsync(
            string id,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRuntimeGetMessageArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RuntimeGetMessageSecurityRequirements,
                operationName: "RuntimeGetMessageAsync");
            ...
            if (xIntegrationAlias != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRuntimeGetMessageRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RuntimeGetMessage",
                                methodName: "RuntimeGetMessageAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRuntimeGetMessageResponse(
                    httpClient: HttpClient,
