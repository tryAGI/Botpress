...
namespace Botpress
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_FilesListFileTagsSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_FilesListFileTagsSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_FilesListFileTagsSecurityRequirement0,
            };
        partial void PrepareFilesListFileTagsArguments(
        ...
        partial void PrepareFilesListFileTagsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessFilesListFileTagsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task FilesListFileTagsAsync(
            string xBotId,
        ...
        {
            await FilesListFileTagsAsResponseAsync(
                xBotId: xBotId,
                nextToken: nextToken,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> FilesListFileTagsAsResponseAsync(
            string xBotId,
            string? nextToken = default,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareFilesListFileTagsArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FilesListFileTagsSecurityRequirements,
                operationName: "FilesListFileTagsAsync");
            ...
            if (xUserRole != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareFilesListFileTagsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FilesListFileTags",
                                methodName: "FilesListFileTagsAsync",
                                pathTemplate: "\"/v1/files/tags\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFilesListFileTagsResponse(
                    httpClient: HttpClient,
