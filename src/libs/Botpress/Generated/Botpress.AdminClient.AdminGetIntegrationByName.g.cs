...
namespace Botpress
{
    public partial class AdminClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_AdminGetIntegrationByNameSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_AdminGetIntegrationByNameSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_AdminGetIntegrationByNameSecurityRequirement0,
            };
        partial void PrepareAdminGetIntegrationByNameArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string name,
            ref string version,
            ref string xWorkspaceId,
            ref string? xMultipleIntegrations);
        partial void PrepareAdminGetIntegrationByNameRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessAdminGetIntegrationByNameResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AdminGetIntegrationByNameAsync(
            string name,
            string version,
            string xWorkspaceId,
        ...
        {
            await AdminGetIntegrationByNameAsResponseAsync(
                name: name,
                version: version,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> AdminGetIntegrationByNameAsResponseAsync(
            string name,
            string version,
            string xWorkspaceId,
            string? xMultipleIntegrations = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAdminGetIntegrationByNameArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AdminGetIntegrationByNameSecurityRequirements,
                operationName: "AdminGetIntegrationByNameAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AdminGetIntegrationByName",
                                methodName: "AdminGetIntegrationByNameAsync",
                                pathTemplate: "$\"/v1/admin/integrations/{name}/{version}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAdminGetIntegrationByNameResponse(
                    httpClient: HttpClient,
