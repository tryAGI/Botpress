...
namespace Botpress
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_FilesUpdateFileMetadataSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_FilesUpdateFileMetadataSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_FilesUpdateFileMetadataSecurityRequirement0,
            };
        partial void PrepareFilesUpdateFileMetadataArguments(
        ...
        partial void PrepareFilesUpdateFileMetadataRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessFilesUpdateFileMetadataResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task FilesUpdateFileMetadataAsync(
            string id,
            string xBotId,
        ...
        {
            await FilesUpdateFileMetadataAsResponseAsync(
                id: id,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> FilesUpdateFileMetadataAsResponseAsync(
            string id,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareFilesUpdateFileMetadataArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FilesUpdateFileMetadataSecurityRequirements,
                operationName: "FilesUpdateFileMetadataAsync");
            ...
            if (xUserRole != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareFilesUpdateFileMetadataRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FilesUpdateFileMetadata",
                                methodName: "FilesUpdateFileMetadataAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFilesUpdateFileMetadataResponse(
                    httpClient: HttpClient,
