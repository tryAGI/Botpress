...
namespace Botpress
{
    public partial class RuntimeClient
    {
        ...
        {
            await RuntimeListParticipantsAsResponseAsync(
                id: id,
                xBotId: xBotId,
                nextToken: nextToken,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeListParticipantsAsResponseAsync(
            string id,
            string xBotId,
            string? nextToken = default,
            string? xIntegrationId = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RuntimeListParticipants",
                                methodName: "RuntimeListParticipantsAsync",
