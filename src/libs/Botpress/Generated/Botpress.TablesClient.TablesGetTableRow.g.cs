...
namespace Botpress
{
    public partial class TablesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_TablesGetTableRowSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_TablesGetTableRowSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_TablesGetTableRowSecurityRequirement0,
            };
        partial void PrepareTablesGetTableRowArguments(
        ...
        partial void PrepareTablesGetTableRowRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessTablesGetTableRowResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task TablesGetTableRowAsync(
            string table,
            int id,
            string xBotId,
        ...
        {
            await TablesGetTableRowAsResponseAsync(
                table: table,
                id: id,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> TablesGetTableRowAsResponseAsync(
            string table,
            int id,
            string xBotId,
            string? xIntegrationId = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTablesGetTableRowArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TablesGetTableRowSecurityRequirements,
                operationName: "TablesGetTableRowAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TablesGetTableRow",
                                methodName: "TablesGetTableRowAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTablesGetTableRowResponse(
                    httpClient: HttpClient,
