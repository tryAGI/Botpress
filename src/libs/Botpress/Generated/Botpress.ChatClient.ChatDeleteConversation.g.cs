...
namespace Botpress
{
    public partial class ChatClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_ChatDeleteConversationSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_ChatDeleteConversationSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_ChatDeleteConversationSecurityRequirement0,
            };
        partial void PrepareChatDeleteConversationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xUserKey,
            ref string id);
        partial void PrepareChatDeleteConversationRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xUserKey,
            string id);
        partial void ProcessChatDeleteConversationResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatDeleteConversationResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Botpress.ChatDeleteConversationResponse> ChatDeleteConversationAsync(
            string xUserKey,
            string id,
            global::Botpress.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ChatDeleteConversationAsResponseAsync(
                xUserKey: xUserKey,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatDeleteConversationResponse>> ChatDeleteConversationAsResponseAsync(
            string xUserKey,
            string id,
            global::Botpress.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareChatDeleteConversationArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatDeleteConversationSecurityRequirements,
                operationName: "ChatDeleteConversationAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareChatDeleteConversationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ChatDeleteConversationAsync",
                                pathTemplate: "$\"/chat-api/conversations/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChatDeleteConversationResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (!__response.IsSuccessStatusCode)
                            {
                                ...
                                global::Botpress.ChatDeleteConversationResponse2? __value_default = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_default = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_default = global::Botpress.ChatDeleteConversationResponse2.FromJson(__content_default, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_default = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Botpress.ApiException<global::Botpress.ChatDeleteConversationResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatDeleteConversationResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Botpress.ChatDeleteConversationResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatDeleteConversationResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Botpress.ChatDeleteConversationResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
