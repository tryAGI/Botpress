...
namespace Botpress
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_FilesListFileTagValuesSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_FilesListFileTagValuesSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_FilesListFileTagValuesSecurityRequirement0,
            };
        partial void PrepareFilesListFileTagValuesArguments(
        ...
        partial void PrepareFilesListFileTagValuesRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessFilesListFileTagValuesResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task FilesListFileTagValuesAsync(
            string tag,
            string xBotId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_FilesListFileTagValuesSecurityRequirements,
                operationName: "FilesListFileTagValuesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareFilesListFileTagValuesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "FilesListFileTagValues",
                                methodName: "FilesListFileTagValuesAsync",
                                pathTemplate: "$\"/v1/files/tags/{tag}/values\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessFilesListFileTagValuesResponse(
                    httpClient: HttpClient,
