...
namespace Botpress
{
    public partial class AdminClient
    {
        ...
        {
            await AdminListPublicIntegrationsAsResponseAsync(
                nextToken: nextToken,
                limit: limit,
                name: name,
                version: version,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> AdminListPublicIntegrationsAsResponseAsync(
            string? nextToken = default,
            double? limit = default,
            string? name = default,
            string? version = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AdminListPublicIntegrations",
                                methodName: "AdminListPublicIntegrationsAsync",
                                pathTemplate: "\"/v1/admin/hub/integrations\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
