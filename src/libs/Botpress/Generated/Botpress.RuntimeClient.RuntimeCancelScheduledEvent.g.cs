...
namespace Botpress
{
    public partial class RuntimeClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_RuntimeCancelScheduledEventSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_RuntimeCancelScheduledEventSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_RuntimeCancelScheduledEventSecurityRequirement0,
            };
        partial void PrepareRuntimeCancelScheduledEventArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string xBotId,
            ref string? xIntegrationId,
            ref string? xIntegrationAlias);
        partial void PrepareRuntimeCancelScheduledEventRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessRuntimeCancelScheduledEventResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RuntimeCancelScheduledEventAsync(
            string id,
            string xBotId,
        ...
        {
            await RuntimeCancelScheduledEventAsResponseAsync(
                id: id,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeCancelScheduledEventAsResponseAsync(
            string id,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRuntimeCancelScheduledEventArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RuntimeCancelScheduledEventSecurityRequirements,
                operationName: "RuntimeCancelScheduledEventAsync");
            ...
            if (xIntegrationAlias != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRuntimeCancelScheduledEventRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RuntimeCancelScheduledEvent",
                                methodName: "RuntimeCancelScheduledEventAsync",
                                pathTemplate: "$\"/v1/chat/events/scheduled/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRuntimeCancelScheduledEventResponse(
                    httpClient: HttpClient,
