...
namespace Botpress
{
    public partial class RuntimeClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_RuntimeGetConversationSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_RuntimeGetConversationSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_RuntimeGetConversationSecurityRequirement0,
            };
        partial void PrepareRuntimeGetConversationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string xBotId,
            ref string? xIntegrationId,
            ref string? xIntegrationAlias);
        partial void PrepareRuntimeGetConversationRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessRuntimeGetConversationResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RuntimeGetConversationAsync(
            string id,
            string xBotId,
        ...
        {
            await RuntimeGetConversationAsResponseAsync(
                id: id,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeGetConversationAsResponseAsync(
            string id,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRuntimeGetConversationArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RuntimeGetConversationSecurityRequirements,
                operationName: "RuntimeGetConversationAsync");
            ...
            if (xIntegrationAlias != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRuntimeGetConversationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RuntimeGetConversation",
                                methodName: "RuntimeGetConversationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRuntimeGetConversationResponse(
                    httpClient: HttpClient,
