...
namespace Botpress
{
    public partial class ChatClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_ChatListParticipantsSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_ChatListParticipantsSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_ChatListParticipantsSecurityRequirement0,
            };
        partial void PrepareChatListParticipantsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xUserKey,
            ref string? nextToken,
            ref string conversationId);
        partial void PrepareChatListParticipantsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xUserKey,
            string? nextToken,
            string conversationId);
        partial void ProcessChatListParticipantsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatListParticipantsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Botpress.ChatListParticipantsResponse> ChatListParticipantsAsync(
            string xUserKey,
            string conversationId,
        ...
        {
            var __response = await ChatListParticipantsAsResponseAsync(
                xUserKey: xUserKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatListParticipantsResponse>> ChatListParticipantsAsResponseAsync(
            string xUserKey,
            string conversationId,
            string? nextToken = default,
            global::Botpress.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareChatListParticipantsArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatListParticipantsSecurityRequirements,
                operationName: "ChatListParticipantsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareChatListParticipantsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatListParticipants",
                                methodName: "ChatListParticipantsAsync",
                                pathTemplate: "$\"/chat-api/conversations/{conversationId}/participants\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChatListParticipantsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (!__response.IsSuccessStatusCode)
                            {
                                ...
                                global::Botpress.ChatListParticipantsResponse2? __value_default = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_default = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_default = global::Botpress.ChatListParticipantsResponse2.FromJson(__content_default, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_default = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Botpress.ApiException<global::Botpress.ChatListParticipantsResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatListParticipantsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Botpress.ChatListParticipantsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatListParticipantsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Botpress.ChatListParticipantsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
