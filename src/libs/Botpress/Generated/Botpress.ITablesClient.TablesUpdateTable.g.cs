...
namespace Botpress
{
    public partial interface ITablesClient
    {
        ...
        global::System.Threading.Tasks.Task TablesUpdateTableAsync(
            string table,
            string xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> TablesUpdateTableAsResponseAsync(
            string table,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
