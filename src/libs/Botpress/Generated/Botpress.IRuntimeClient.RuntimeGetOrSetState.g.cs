...
namespace Botpress
{
    public partial interface IRuntimeClient
    {
        ...
        global::System.Threading.Tasks.Task RuntimeGetOrSetStateAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeGetOrSetStateAsResponseAsync(
            global::Botpress.RuntimeGetOrSetStateType type,
            string id,
            string name,
            string xBotId,
