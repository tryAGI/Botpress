...
namespace Botpress
{
    public partial class RuntimeClient
    {
        ...
        partial void PrepareRuntimeListUsersArguments(
            ...
            ref global::Botpress.RuntimeListUsersRangeField? rangeField,
            ref global::Botpress.RuntimeListUsersSortField? sortField,
            ref global::Botpress.RuntimeListUsersSortDirection? sortDirection,
            ref string xBotId,
            ref string? xIntegrationId,
            ref string? xIntegrationAlias);
        partial void PrepareRuntimeListUsersRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? afterDate,
            string? beforeDate,
            global::Botpress.RuntimeListUsersRangeField? rangeField,
            global::Botpress.RuntimeListUsersSortField? sortField,
            global::Botpress.RuntimeListUsersSortDirection? sortDirection,
            string xBotId,
            string? xIntegrationId,
            string? xIntegrationAlias);
        partial void ProcessRuntimeListUsersResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RuntimeListUsersAsync(
            string xBotId,
        ...
        {
            await RuntimeListUsersAsResponseAsync(
                xBotId: xBotId,
                nextToken: nextToken,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeListUsersAsResponseAsync(
            string xBotId,
            string? nextToken = default,
            string? conversationId = default,
            global::System.Collections.Generic.Dictionary<string, string>? tags = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRuntimeListUsersArguments(
            ...
            if (xIntegrationAlias != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRuntimeListUsersRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RuntimeListUsers",
                                methodName: "RuntimeListUsersAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRuntimeListUsersResponse(
                    httpClient: HttpClient,
