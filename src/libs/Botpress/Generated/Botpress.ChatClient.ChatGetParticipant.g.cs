...
namespace Botpress
{
    public partial class ChatClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_ChatGetParticipantSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_ChatGetParticipantSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_ChatGetParticipantSecurityRequirement0,
            };
        partial void PrepareChatGetParticipantArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xUserKey,
            ref string conversationId,
            ref string userId);
        partial void PrepareChatGetParticipantRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xUserKey,
            string conversationId,
            string userId);
        partial void ProcessChatGetParticipantResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatGetParticipantResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Botpress.ChatGetParticipantResponse> ChatGetParticipantAsync(
            string xUserKey,
            string conversationId,
            string userId,
        ...
        {
            var __response = await ChatGetParticipantAsResponseAsync(
                xUserKey: xUserKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatGetParticipantResponse>> ChatGetParticipantAsResponseAsync(
            string xUserKey,
            string conversationId,
            string userId,
            global::Botpress.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareChatGetParticipantArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatGetParticipantSecurityRequirements,
                operationName: "ChatGetParticipantAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareChatGetParticipantRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatGetParticipant",
                                methodName: "ChatGetParticipantAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessChatGetParticipantResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (!__response.IsSuccessStatusCode)
                            {
                                ...
                                global::Botpress.ChatGetParticipantResponse2? __value_default = null;
                                try
                                {
                                ...
                                throw global::Botpress.ApiException<global::Botpress.ChatGetParticipantResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatGetParticipantResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Botpress.ChatGetParticipantResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatGetParticipantResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Botpress.ChatGetParticipantResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
