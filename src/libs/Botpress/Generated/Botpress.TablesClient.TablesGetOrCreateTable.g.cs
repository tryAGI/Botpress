...
namespace Botpress
{
    public partial class TablesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_TablesGetOrCreateTableSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_TablesGetOrCreateTableSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_TablesGetOrCreateTableSecurityRequirement0,
            };
        partial void PrepareTablesGetOrCreateTableArguments(
        ...
        partial void PrepareTablesGetOrCreateTableRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessTablesGetOrCreateTableResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task TablesGetOrCreateTableAsync(
            string table,
            string xBotId,
        ...
        {
            await TablesGetOrCreateTableAsResponseAsync(
                table: table,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> TablesGetOrCreateTableAsResponseAsync(
            string table,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTablesGetOrCreateTableArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TablesGetOrCreateTableSecurityRequirements,
                operationName: "TablesGetOrCreateTableAsync");
            ...
            if (xUserRole != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTablesGetOrCreateTableRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TablesGetOrCreateTable",
                                methodName: "TablesGetOrCreateTableAsync",
                                pathTemplate: "$\"/v1/tables/{table}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTablesGetOrCreateTableResponse(
                    httpClient: HttpClient,
