...
namespace Botpress
{
    public partial class AdminClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_AdminGetBotIssueSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_AdminGetBotIssueSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_AdminGetBotIssueSecurityRequirement0,
            };
        partial void PrepareAdminGetBotIssueArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string issueId,
            ref string xWorkspaceId,
            ref string? xMultipleIntegrations);
        partial void PrepareAdminGetBotIssueRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessAdminGetBotIssueResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AdminGetBotIssueAsync(
            string id,
            string issueId,
            string xWorkspaceId,
        ...
        {
            await AdminGetBotIssueAsResponseAsync(
                id: id,
                issueId: issueId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> AdminGetBotIssueAsResponseAsync(
            string id,
            string issueId,
            string xWorkspaceId,
            string? xMultipleIntegrations = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAdminGetBotIssueArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AdminGetBotIssueSecurityRequirements,
                operationName: "AdminGetBotIssueAsync");
            ...
            if (xMultipleIntegrations != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAdminGetBotIssueRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AdminGetBotIssue",
                                methodName: "AdminGetBotIssueAsync",
                                pathTemplate: "$\"/v1/admin/bots/{id}/issues/{issueId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAdminGetBotIssueResponse(
                    httpClient: HttpClient,
