...
namespace Botpress
{
    public partial class TablesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_TablesDeleteTableSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_TablesDeleteTableSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_TablesDeleteTableSecurityRequirement0,
            };
        partial void PrepareTablesDeleteTableArguments(
        ...
        partial void PrepareTablesDeleteTableRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessTablesDeleteTableResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task TablesDeleteTableAsync(
            string table,
            string xBotId,
        ...
        {
            await TablesDeleteTableAsResponseAsync(
                table: table,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> TablesDeleteTableAsResponseAsync(
            string table,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTablesDeleteTableArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TablesDeleteTableSecurityRequirements,
                operationName: "TablesDeleteTableAsync");
            ...
            if (xUserRole != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTablesDeleteTableRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TablesDeleteTable",
                                methodName: "TablesDeleteTableAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTablesDeleteTableResponse(
                    httpClient: HttpClient,
