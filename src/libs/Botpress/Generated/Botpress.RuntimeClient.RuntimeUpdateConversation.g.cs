...
namespace Botpress
{
    public partial class RuntimeClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_RuntimeUpdateConversationSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_RuntimeUpdateConversationSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_RuntimeUpdateConversationSecurityRequirement0,
            };
        partial void PrepareRuntimeUpdateConversationArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string xBotId,
            ref string? xIntegrationId,
            ref string? xIntegrationAlias);
        partial void PrepareRuntimeUpdateConversationRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessRuntimeUpdateConversationResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RuntimeUpdateConversationAsync(
            string id,
            string xBotId,
        ...
        {
            await RuntimeUpdateConversationAsResponseAsync(
                id: id,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeUpdateConversationAsResponseAsync(
            string id,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRuntimeUpdateConversationArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RuntimeUpdateConversationSecurityRequirements,
                operationName: "RuntimeUpdateConversationAsync");
            ...
            if (xIntegrationAlias != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRuntimeUpdateConversationRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RuntimeUpdateConversation",
                                methodName: "RuntimeUpdateConversationAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRuntimeUpdateConversationResponse(
                    httpClient: HttpClient,
