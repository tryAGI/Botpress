...
namespace Botpress
{
    public partial class AdminClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_AdminGetBotAnalyticsSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_AdminGetBotAnalyticsSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_AdminGetBotAnalyticsSecurityRequirement0,
            };
        partial void PrepareAdminGetBotAnalyticsArguments(
        ...
        partial void PrepareAdminGetBotAnalyticsRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessAdminGetBotAnalyticsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AdminGetBotAnalyticsAsync(
            string id,
            string startDate,
            string endDate,
            string xWorkspaceId,
        ...
        {
            await AdminGetBotAnalyticsAsResponseAsync(
                id: id,
                startDate: startDate,
                endDate: endDate,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> AdminGetBotAnalyticsAsResponseAsync(
            string id,
            string startDate,
            string endDate,
            string xWorkspaceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAdminGetBotAnalyticsArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AdminGetBotAnalyticsSecurityRequirements,
                operationName: "AdminGetBotAnalyticsAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AdminGetBotAnalytics",
                                methodName: "AdminGetBotAnalyticsAsync",
                                pathTemplate: "$\"/v1/admin/bots/{id}/analytics\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAdminGetBotAnalyticsResponse(
                    httpClient: HttpClient,
