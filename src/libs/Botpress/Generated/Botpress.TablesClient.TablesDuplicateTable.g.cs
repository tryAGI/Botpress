...
namespace Botpress
{
    public partial class TablesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_TablesDuplicateTableSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_TablesDuplicateTableSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_TablesDuplicateTableSecurityRequirement0,
            };
        partial void PrepareTablesDuplicateTableArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string sourceTableId,
            ref string xBotId,
        ...
        partial void PrepareTablesDuplicateTableRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessTablesDuplicateTableResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task TablesDuplicateTableAsync(
            string sourceTableId,
            string xBotId,
        ...
        {
            await TablesDuplicateTableAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> TablesDuplicateTableAsResponseAsync(
            string sourceTableId,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTablesDuplicateTableArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TablesDuplicateTableSecurityRequirements,
                operationName: "TablesDuplicateTableAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TablesDuplicateTable",
                                methodName: "TablesDuplicateTableAsync",
                                pathTemplate: "$\"/v1/tables/{sourceTableId}/duplicate\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTablesDuplicateTableResponse(
                    httpClient: HttpClient,
