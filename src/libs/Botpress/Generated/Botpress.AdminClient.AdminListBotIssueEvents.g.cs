...
namespace Botpress
{
    public partial class AdminClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_AdminListBotIssueEventsSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_AdminListBotIssueEventsSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_AdminListBotIssueEventsSecurityRequirement0,
            };
        partial void PrepareAdminListBotIssueEventsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string issueId,
            ref string xWorkspaceId,
            ref string? xMultipleIntegrations);
        partial void PrepareAdminListBotIssueEventsRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AdminListBotIssueEventsAsync(
            string id,
            string issueId,
            string xWorkspaceId,
        ...
        {
            await AdminListBotIssueEventsAsResponseAsync(
                id: id,
                issueId: issueId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> AdminListBotIssueEventsAsResponseAsync(
            string id,
            string issueId,
            string xWorkspaceId,
            string? xMultipleIntegrations = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAdminListBotIssueEventsArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AdminListBotIssueEventsSecurityRequirements,
                operationName: "AdminListBotIssueEventsAsync");
            ...
            if (xMultipleIntegrations != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAdminListBotIssueEventsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AdminListBotIssueEvents",
                                methodName: "AdminListBotIssueEventsAsync",
                                pathTemplate: "$\"/v1/admin/bots/{id}/issues/{issueId}/events\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAdminListBotIssueEventsResponse(
                    httpClient: HttpClient,
