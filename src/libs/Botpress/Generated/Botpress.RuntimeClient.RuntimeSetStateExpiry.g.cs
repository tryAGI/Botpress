...
namespace Botpress
{
    public partial class RuntimeClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_RuntimeSetStateExpirySecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_RuntimeSetStateExpirySecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_RuntimeSetStateExpirySecurityRequirement0,
            };
        partial void PrepareRuntimeSetStateExpiryArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref global::Botpress.RuntimeSetStateExpiryType type,
            ref string id,
            ref string name,
            ref string xBotId,
            ref string? xIntegrationId,
            ref string? xIntegrationAlias);
        partial void PrepareRuntimeSetStateExpiryRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessRuntimeSetStateExpiryResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RuntimeSetStateExpiryAsync(
            global::Botpress.RuntimeSetStateExpiryType type,
            string id,
            string name,
            string xBotId,
        ...
        {
            await RuntimeSetStateExpiryAsResponseAsync(
                type: type,
                id: id,
                name: name,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeSetStateExpiryAsResponseAsync(
            global::Botpress.RuntimeSetStateExpiryType type,
            string id,
            string name,
            string xBotId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRuntimeSetStateExpiryArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RuntimeSetStateExpirySecurityRequirements,
                operationName: "RuntimeSetStateExpiryAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Botpress.PathBuilder(
                                path: $"/v1/chat/states/{(global::System.Uri.EscapeDataString(type.ToValueString()))}/{id}/{name}/expiry",
            ...
            if (xIntegrationAlias != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRuntimeSetStateExpiryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RuntimeSetStateExpiry",
                                methodName: "RuntimeSetStateExpiryAsync",
                                pathTemplate: "$\"/v1/chat/states/{(global::System.Uri.EscapeDataString(type.ToValueString()))}/{id}/{name}/expiry\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRuntimeSetStateExpiryResponse(
                    httpClient: HttpClient,
