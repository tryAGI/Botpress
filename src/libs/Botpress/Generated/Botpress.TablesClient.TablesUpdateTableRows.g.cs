...
namespace Botpress
{
    public partial class TablesClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_TablesUpdateTableRowsSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_TablesUpdateTableRowsSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_TablesUpdateTableRowsSecurityRequirement0,
            };
        partial void PrepareTablesUpdateTableRowsArguments(
        ...
        partial void PrepareTablesUpdateTableRowsRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? xUserId,
            string? xUserRole);
        partial void ProcessTablesUpdateTableRowsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task TablesUpdateTableRowsAsync(
            string table,
            string xBotId,
        ...
        {
            await TablesUpdateTableRowsAsResponseAsync(
                table: table,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> TablesUpdateTableRowsAsResponseAsync(
            string table,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareTablesUpdateTableRowsArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TablesUpdateTableRowsSecurityRequirements,
                operationName: "TablesUpdateTableRowsAsync");
            ...
            if (xUserRole != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTablesUpdateTableRowsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TablesUpdateTableRows",
                                methodName: "TablesUpdateTableRowsAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTablesUpdateTableRowsResponse(
                    httpClient: HttpClient,
