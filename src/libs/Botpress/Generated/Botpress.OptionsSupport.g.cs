...
namespace Botpress
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Botpress.AutoSDKRetryOptions Retry { get; set; } = new global::Botpress.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Botpress.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Botpress.IAutoSDKHook>();
        ...
        public global::Botpress.AutoSDKClientOptions AddHook(
            global::Botpress.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Botpress.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Botpress.AutoSDKClientOptions UseAuthorizationProvider(
            global::Botpress.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Botpress.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Botpress.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Botpress.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Botpress.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Botpress.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Botpress.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Botpress.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Botpress.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Botpress.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Botpress.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Botpress.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Botpress.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Botpress.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Botpress.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Botpress.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Botpress.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Botpress.AutoSDKClientOptions clientOptions,
            global::Botpress.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Botpress.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Botpress.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Botpress.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Botpress.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Botpress.IAutoSDKHook, global::Botpress.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Botpress.AutoSDKHookContext context)
        {
