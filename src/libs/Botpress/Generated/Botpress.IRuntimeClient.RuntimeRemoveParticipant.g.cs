...
namespace Botpress
{
    public partial interface IRuntimeClient
    {
        ...
        global::System.Threading.Tasks.Task RuntimeRemoveParticipantAsync(
            string id,
            string userId,
            string xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeRemoveParticipantAsResponseAsync(
            string id,
            string userId,
            string xBotId,
            string? xIntegrationId = default,
