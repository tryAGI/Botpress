...
namespace Botpress
{
    public partial interface IRuntimeClient
    {
        ...
        global::System.Threading.Tasks.Task RuntimeGetUserAsync(
            string id,
            string xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeGetUserAsResponseAsync(
            string id,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
