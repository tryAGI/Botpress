...
namespace Botpress
{
    public partial class ChatClient
    {
        ...
        {
            var __response = await ChatGetOrCreateUserAsResponseAsync(
                xUserKey: xUserKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatGetOrCreateUserResponse>> ChatGetOrCreateUserAsResponseAsync(
            string xUserKey,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatGetOrCreateUser",
                                methodName: "ChatGetOrCreateUserAsync",
                                pathTemplate: "\"/chat-api/users/get-or-create\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (!__response.IsSuccessStatusCode)
                            {
                                ...
                                throw global::Botpress.ApiException<global::Botpress.ChatGetOrCreateUserResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Botpress.ChatGetOrCreateUserResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatGetOrCreateUserResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Botpress.ChatGetOrCreateUserResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
