...
namespace Botpress
{
    public partial class ChatClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_ChatUpdateUserSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_ChatUpdateUserSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_ChatUpdateUserSecurityRequirement0,
            };
        partial void PrepareChatUpdateUserArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string xUserKey,
            global::Botpress.ChatUpdateUserRequest request);
        partial void PrepareChatUpdateUserRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string xUserKey,
            global::Botpress.ChatUpdateUserRequest request);
        partial void ProcessChatUpdateUserResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessChatUpdateUserResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Botpress.ChatUpdateUserResponse> ChatUpdateUserAsync(
            string xUserKey,
        ...
        {
            var __response = await ChatUpdateUserAsResponseAsync(
                xUserKey: xUserKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatUpdateUserResponse>> ChatUpdateUserAsResponseAsync(
            string xUserKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareChatUpdateUserArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ChatUpdateUserSecurityRequirements,
                operationName: "ChatUpdateUserAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ChatUpdateUser",
                                methodName: "ChatUpdateUserAsync",
                                pathTemplate: "\"/chat-api/users/me\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (!__response.IsSuccessStatusCode)
                            {
                                ...
                                global::Botpress.ChatUpdateUserResponse2? __value_default = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_default = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_default = global::Botpress.ChatUpdateUserResponse2.FromJson(__content_default, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_default = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::Botpress.ApiException<global::Botpress.ChatUpdateUserResponse2>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessChatUpdateUserResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Botpress.ChatUpdateUserResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Botpress.AutoSDKHttpResponse<global::Botpress.ChatUpdateUserResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Botpress.ChatUpdateUserResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ChatUpdateUserAsync(
                xUserKey: xUserKey,
                request: __request,
                requestOptions: requestOptions,
