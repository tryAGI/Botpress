...
namespace Botpress
{
    public partial class RuntimeClient
    {
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement s_RuntimeAddParticipantSecurityRequirement0 =
        ...
        private static readonly global::Botpress.EndPointSecurityRequirement[] s_RuntimeAddParticipantSecurityRequirements =
            new global::Botpress.EndPointSecurityRequirement[]
            {                s_RuntimeAddParticipantSecurityRequirement0,
            };
        partial void PrepareRuntimeAddParticipantArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string xBotId,
            ref string? xIntegrationId,
            ref string? xIntegrationAlias);
        partial void PrepareRuntimeAddParticipantRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessRuntimeAddParticipantResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RuntimeAddParticipantAsync(
            string id,
            string xBotId,
        ...
        {
            await RuntimeAddParticipantAsResponseAsync(
                id: id,
                xBotId: xBotId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Botpress.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Botpress.AutoSDKHttpResponse> RuntimeAddParticipantAsResponseAsync(
            string id,
            string xBotId,
            string? xIntegrationId = default,
            string? xIntegrationAlias = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRuntimeAddParticipantArguments(
            ...
            var __authorizations = global::Botpress.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RuntimeAddParticipantSecurityRequirements,
                operationName: "RuntimeAddParticipantAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Botpress.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Botpress.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RuntimeAddParticipant",
                                methodName: "RuntimeAddParticipantAsync",
                                pathTemplate: "$\"/v1/chat/conversations/{id}/participants\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRuntimeAddParticipantResponse(
                    httpClient: HttpClient,
