...
namespace Botpress.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Botpress.CLI";
    private const string UserSecretApiKeyName = "BOTPRESS_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"BOTPRESS_API_KEY"];
    private const string CredentialFileDirectoryName = ".botpress";

    public static async global::System.Threading.Tasks.Task<global::Botpress.BotpressClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        return new global::Botpress.BotpressClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("BOTPRESS_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Botpress.ApiException exception)
    {
        var builder = new StringBuilder();
