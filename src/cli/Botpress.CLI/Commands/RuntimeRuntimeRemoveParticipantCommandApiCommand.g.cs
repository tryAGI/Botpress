...
internal static partial class RuntimeRuntimeRemoveParticipantCommandApiCommand
{
    ...
    {
        var command = new Command(@"remove-participant", @"Remove a [Participant](#schema_participant) from a [Conversation](#schema_conversation).");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                await client.Runtime.RuntimeRemoveParticipantAsync(
                                    id: id,
                                    userId: userId,
                                    xBotId: xBotId,
