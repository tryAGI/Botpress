...
internal static partial class RuntimeRuntimeGetStateCommandApiCommand
{
    private static Argument<global::Botpress.RuntimeGetStateType> Type { get; } = new(
        name: @"type")
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                await client.Runtime.RuntimeGetStateAsync(
                                    type: type,
                                    id: id,
                                    name: name,
                                    xBotId: xBotId,
