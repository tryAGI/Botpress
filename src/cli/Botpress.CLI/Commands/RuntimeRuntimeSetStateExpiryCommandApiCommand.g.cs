...
internal static partial class RuntimeRuntimeSetStateExpiryCommandApiCommand
{
    private static Argument<global::Botpress.RuntimeSetStateExpiryType> Type { get; } = new(
        name: @"type")
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                await client.Runtime.RuntimeSetStateExpiryAsync(
                                    type: type,
                                    id: id,
                                    name: name,
                                    xBotId: xBotId,
