...
internal static partial class RuntimeRuntimeGetConversationCommandApiCommand
{
    ...
    {
        var command = new Command(@"get-conversation", @"Retrieves the [Conversation](#schema_conversation) object for a valid identifier.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                await client.Runtime.RuntimeGetConversationAsync(
                                    id: id,
                                    xBotId: xBotId,
