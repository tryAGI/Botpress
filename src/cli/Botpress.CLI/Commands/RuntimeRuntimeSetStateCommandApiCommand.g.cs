...
internal static partial class RuntimeRuntimeSetStateCommandApiCommand
{
    private static Argument<global::Botpress.RuntimeSetStateType> Type { get; } = new(
        name: @"type")
    {
    ...
    {
        var command = new Command(@"set-state", @"Overrides the [State](#schema_state) object by setting the values of the parameters passed.");
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                await client.Runtime.RuntimeSetStateAsync(
                                    type: type,
                                    id: id,
                                    name: name,
                                    xBotId: xBotId,
