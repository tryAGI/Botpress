...
internal static partial class ChatChatRemoveParticipantCommandApiCommand
{
        ...
        name: @"--x-user-key")
    {
        ...
        Required = true,
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Botpress.ChatRemoveParticipantResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Botpress.ChatRemoveParticipantResponse value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Chat.ChatRemoveParticipantAsync(
