...
internal static partial class AdminAdminGetBotAnalyticsCommandApiCommand
{
    ...
    private static Option<string> StartDate { get; } = new(
        name: @"--start-date")
    {
    ...
    private static Option<string> EndDate { get; } = new(
        name: @"--end-date")
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                await client.Admin.AdminGetBotAnalyticsAsync(
                                    id: id,
                                    startDate: startDate,
                                    endDate: endDate,
